                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.6 }} className="bg-gray-200 w-40  absolute shadow-xl flex flex-col rounded-xl right-1">
                      {
                        user.email === "apurvgupta.124@gmail.com" && (
                          <p className="flex items-center gap-2  cursor-pointer hover:bg-slate-300 rounded-lg px-3 py-2 transition-all duration-100 ease-in-out" onClick={() => navigate("/createItem")} >New Item <MdAdd size={20} /></p>
                        )
                      }

                      <p className="flex items-center gap-2 hover:bg-slate-300 rounded-lg px-3 py-2 transition-all duration-100 ease-in-out cursor-pointer" onClick={Logout}>Logout <MdLogout /></p>
                    </motion.div>
...

            {
              isMenu && (
                <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.6 }} className="bg-gray-200 w-40  absolute shadow-xl flex flex-col rounded-xl right-1">
                  {
                    user.email === "apurvgupta.124@gmail.com" && (
                      <p className="flex items-center gap-2 hover:bg-slate-300 rounded-lg px-3 py-2 transition-all duration-100 ease-in-out cursor-pointer" onClick={() => navigate("/createItem")} >New Item <MdAdd size={20} /></p>
                    )
                  }
                  ...
                  <p className="flex items-center justify-center gap-2 hover:bg-slate-300 rounded-lg px-3 py-2 transition-all duration-100 cursor-pointer ease-in-out bg-slate-400" onClick={Logout}>Logout <MdLogout /></p>
                </motion.div>
